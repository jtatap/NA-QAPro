...
function loadBot(options, prechatFormDetails, prechatInfo){
    ...
    var initESW = function(gslbBaseURL, buttonId, deploymentId) {
        ...
        embedded_svc.settings.avatarImgURL = options.contentURL + eswOptions.resourceBase + '/img/Sales_Expert.svg';
        embedded_svc.settings.chatbotAvatarImgURL = options.contentURL + eswOptions.resourceBase + '/img/CK_Assistant.svg';
