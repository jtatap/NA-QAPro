...
function initBot(options) {
    ...
    let brand = "82";
    if (location.href && (location.href.indexOf('izod') !== -1 || location.href.indexOf('iz-') !== -1)) {
        brand = "81";
    }
...
function loadBot(options, prechatFormDetails, prechatInfo){
    ...
    function helpButtonLoaded() {
        ...
        var height = document.querySelector('.helpButton').clientHeight;
        var width = document.querySelector('.helpButton').clientWidth;
        console.log("helpButtonLoaded height:" + height); // check the message is being sent correctly
        console.log("helpButtonLoaded width:" + width); // check the message is being sent correctly
    ...
    var initESW = function(gslbBaseURL, buttonId, deploymentId) {
        ...
        embedded_svc.settings.avatarImgURL = options.contentURL + eswOptions.resourceBase + '/img/person.crop.fill.white.png?a=2';
        embedded_svc.settings.chatbotAvatarImgURL = options.contentURL + eswOptions.resourceBase + '/img/quote.bubble.fill.png';
        ...
        embedded_svc.settings.extraPrechatInfo = prechatInfo || [];
        ...
        embedded_svc.addEventHandler("afterDestroy", function() {
            let height = document.querySelector('.helpButton').clientHeight;
            let width = document.querySelector('.helpButton').clientWidth;
