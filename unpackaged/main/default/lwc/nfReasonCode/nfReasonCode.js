...
import EliteCompetition from '@salesforce/label/c.Elite_LZR_Competition';
import GnrlSwimwear from '@salesforce/label/c.General_Swimwear';
import Reason_Code_Details from '@salesforce/label/c.Reason_Code_Details';
import Reason_Sub_Detail from '@salesforce/label/c.Reason_Sub_Detail';
import Product_Category from '@salesforce/label/c.Product_Category';
import Product_Sub_Category from '@salesforce/label/c.Product_Sub_Category';
...
export default class Example extends LightningElement {
    ...
    */
    ...
    get display_Reason_Code_Product_Category__c() {
        ...
        if (this.mapData.Reason_Code_Product_Category__c.value != null) {
            return true;
        }
    ...
    get display_Reason_Code_Product_Sub_Categories_Widge__c() {
        ...
        if (this.mapData.Reason_Code_Product_Sub_Categories_Widge__c.value != null) {
            return true;
        }
    ...
    @wire(getPicklistValues, {
        recordTypeId: "0121U000000SgktQAC",
        fieldApiName: REASON_CODE_FIELD
    })
    wiredPicklistValues({
        error,
        data
